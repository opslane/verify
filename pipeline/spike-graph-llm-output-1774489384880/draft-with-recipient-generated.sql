...
BEGIN
  ...
  VALUES (gen_random_uuid(), gen_random_uuid(), 'DOCUMENT'::"EnvelopeType", NOW(), NOW(), 'Service Agreement', 'DRAFT'::"DocumentStatus", 'DOCUMENT'::"DocumentSource", 1, false, 'EVERYONE'::"DocumentVisibility", 'PUBLIC'::"TemplateType", '', '', 9, 7, v_documentmeta_id, gen_random_uuid())
  ...
  VALUES (gen_random_uuid(), 'Main Document', v_documentdata_id, v_envelope_id, 0)
